    ...
    <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          <View style={styles.rowLeft}>
            <View style={styles.iconWrap}><Ionicons name="notifications-outline" size={18} color="#3d7a00" /></View>
        ...
        <View style={styles.row}>
          <View style={styles.rowLeft}>
            <View style={styles.iconWrap}><Ionicons name="location-outline" size={18} color="#3d7a00" /></View>
        ...
        <View style={styles.row}>
          <View style={styles.rowLeft}>
            <View style={styles.iconWrap}><Ionicons name="moon-outline" size={18} color="#3d7a00" /></View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.row} activeOpacity={0.8}>
          <View style={styles.rowLeft}>
            <View style={styles.iconWrap}><Ionicons name="lock-closed-outline" size={18} color="#3d7a00" /></View>
        ...
        <TouchableOpacity style={styles.row} activeOpacity={0.8}>
          <View style={styles.rowLeft}>
            <View style={styles.iconWrap}><Ionicons name="help-circle-outline" size={18} color="#3d7a00" /></View>
