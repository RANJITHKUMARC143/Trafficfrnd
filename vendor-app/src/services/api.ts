...
export const API_URL = 'https://traffic-friend-backend.onrender.com';
...
class SocketService {
  private readonly SOCKET_URL = 'https://traffic-friend-backend.onrender.com'; // Updated backend socket URL
} 